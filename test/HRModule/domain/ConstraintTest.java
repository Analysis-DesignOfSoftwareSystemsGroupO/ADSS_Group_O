...
public class ConstraintTest {
    ...
    public void testSetExplanationAsHR() {
        constraint.setExplanation(employee, "Updated");
    ...
    public void testSetExplanationAsSelf() {
        constraint.setExplanation( employee, "New Reason");
    ...
    public void testSetExplanationNull() {
        assertThrows(NullPointerException.class, () -> {
            constraint.setExplanation( employee, null);
        });
    }
    ...
    public void testSetExplanationEmptyString() {
        constraint.setExplanation( employee, "");
