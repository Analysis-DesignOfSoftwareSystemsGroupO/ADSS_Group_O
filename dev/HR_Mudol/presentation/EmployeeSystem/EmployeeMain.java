...
public class EmployeeMain {
    ...
    public static void main(String[] args) {
        ...
        Employee emp = new Employee("Dana", 123456789, "pass", "123456", 5000, LocalDate.now(), 2, 2, 5, 10);
