...
public class EmploymentContractRepositoryDAOImpl implements IEmploymentContractRepositoryDAO {
    private final Connection conn;

    public EmploymentContractRepositoryDAOImpl(Connection conn) {
        this.conn = conn;
    }
